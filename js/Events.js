...
// As of now it changes the vid in the main box but we want it to always make a
// new box and play the youtube vid inside
function pointClicked(data) {
  YT_id = data.youtube_id;
  var url =
      "https://www.googleapis.com/youtube/v3/videos?key=AIzaSyCgM1_j6IwbthlvgEhg_k7oZZ3OjowF7ms&part=snippet&id=" +
      YT_id
  console.log(url)
  ...
  if (!player) {
    ...
    if (player.loadVideoById) {
      ...
      player.loadVideoById(YT_id, data.yt_start);
    }
  }
  return YT_id;
}
